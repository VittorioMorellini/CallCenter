...
public partial class CcDbContext : DbContext
{
    ...
    public virtual DbSet<AppointmentEnding> AppointmentEnding { get; set; }

    public virtual DbSet<AppointmentReject> AppointmentReject { get; set; }

    public virtual DbSet<AppointmentType> AppointmentType { get; set; }

    public virtual DbSet<Broadcasting> Broadcasting { get; set; }

    public virtual DbSet<BroadcastingProduct> BroadcastingProduct { get; set; }

    public virtual DbSet<BroadcastingTabRegion> BroadcastingTabRegion { get; set; }
    ...
    public virtual DbSet<CustomerRequiredField> CustomerRequiredField { get; set; }
    ...
    public virtual DbSet<LogQuery> LogQuery { get; set; }
    ...
    public virtual DbSet<PrincipalAuth> PrincipalAuth { get; set; }

    public virtual DbSet<PrincipalFather> PrincipalFather { get; set; }

    public virtual DbSet<PrincipalGrouping> PrincipalGrouping { get; set; }

    public virtual DbSet<PrincipalRole> PrincipalRole { get; set; }

    public virtual DbSet<PrincipalTabRegion> PrincipalTabRegion { get; set; }
    ...
    public virtual DbSet<TabCity> TabCity { get; set; }

    public virtual DbSet<TabCountry> TabCountry { get; set; }

    public virtual DbSet<TabDistrict> TabDistrict { get; set; }

    public virtual DbSet<TabRegion> TabRegion { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Agency>(entity =>
        {
            ...
            entity.HasOne(d => d.Company).WithMany(p => p.Agency)
        ...
        modelBuilder.Entity<BroadcastingProduct>(entity =>
        {
            ...
            entity.HasOne(d => d.Broadcasting).WithMany(p => p.BroadcastingProduct)
                .HasForeignKey(d => d.BroadcastingId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_BroadcastingProduct_Broadcasting");

            entity.HasOne(d => d.Product).WithMany(p => p.BroadcastingProduct)
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_BroadcastingRegion");
            ...
            entity.HasOne(d => d.Broadcasting).WithMany(p => p.BroadcastingTabRegion)
                .HasForeignKey(d => d.BroadcastingId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_BroadcastingTabRegion_Broadcasting");

            entity.HasOne(d => d.TabRegion).WithMany(p => p.BroadcastingTabRegion)
        ...
        {
            entity.HasIndex(e => e.CompanyId, "UQ_Configuration").IsUnique();
            ...
            entity.HasOne(d => d.Company).WithOne(p => p.Configuration)
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasOne(d => d.Agency).WithMany(p => p.Customer)
                .HasForeignKey(d => d.AgencyId)
                .HasConstraintName("FK_Customer_Agency");

            entity.HasOne(d => d.Broadcasting).WithMany(p => p.Customer)
                .HasForeignKey(d => d.BroadcastingId)
            ...
            entity.HasOne(d => d.District).WithMany(p => p.Customer)
            ...
            entity.HasOne(d => d.Salesman).WithMany(p => p.Customer)
                .HasForeignKey(d => d.SalesmanId)
        ...
        modelBuilder.Entity<CustomerCall>(entity =>
        {
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.CustomerCall)
                .HasForeignKey(d => d.CustomerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CustomerCall_Customer");

            entity.HasOne(d => d.Principal).WithMany(p => p.CustomerCall)
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_CustomerRequiredFields");
            ...
            entity.HasOne(d => d.Agency).WithMany(p => p.CustomerRequiredField)
                .HasForeignKey(d => d.AgencyId)
                .HasConstraintName("FK_CustomerRequiredField_Agency");

            entity.HasOne(d => d.Company).WithMany(p => p.CustomerRequiredField)
                .HasForeignKey(d => d.CompanyId)
                .HasConstraintName("FK_CustomerRequiredField_Company");

            entity.HasOne(d => d.Product).WithMany(p => p.CustomerRequiredField)
                .HasForeignKey(d => d.ProductId)
        ...
        modelBuilder.Entity<Event>(entity =>
        {
            ...
            entity.HasOne(d => d.Order).WithMany(p => p.Event)
        ...
        modelBuilder.Entity<EventAttachment>(entity =>
        {
            ...
            entity.HasOne(d => d.Event).WithMany(p => p.EventAttachment)
        ...
        modelBuilder.Entity<Investment>(entity =>
        {
            ...
            entity.HasOne(d => d.Broadcasting).WithMany(p => p.Investment)
                .HasForeignKey(d => d.BroadcastingId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Investment_Broadcasting");

            entity.HasOne(d => d.Category).WithMany(p => p.Investment)
                .HasForeignKey(d => d.CategoryId)
                .HasConstraintName("FK_Investment_Category");

            entity.HasOne(d => d.Product).WithMany(p => p.Investment)
                .HasForeignKey(d => d.ProductId)
        ...
        modelBuilder.Entity<OrderPayment>(entity =>
        {
            ...
            entity.HasOne(d => d.Order).WithMany(p => p.OrderPayment)
                .HasForeignKey(d => d.OrderId)
                .HasConstraintName("FK_OrderPayment_OrderTable");
        });
        ...
        modelBuilder.Entity<OrderRow>(entity =>
        {
            ...
            entity.HasOne(d => d.Measure).WithMany(p => p.OrderRow)
                .HasForeignKey(d => d.MeasureId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_OrderRow_Measure");

            entity.HasOne(d => d.Order).WithMany(p => p.OrderRow)
                .HasForeignKey(d => d.OrderId)
                .HasConstraintName("FK_OrderRow_OrderTable");

            entity.HasOne(d => d.Product).WithMany(p => p.OrderRow)
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<OrderTable>(entity =>
        {
            ...
            entity.HasOne(d => d.OrderState).WithMany(p => p.OrderTable)
                .HasForeignKey(d => d.OrderStateId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_OrderTable_OrderState");
        });
        ...
        modelBuilder.Entity<Principal>(entity =>
        {
            ...
            entity.HasOne(d => d.Avatar).WithMany(p => p.Principal)
                .HasForeignKey(d => d.AvatarId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("FK_Principal_Document");

            entity.HasOne(d => d.Company).WithMany(p => p.Principal)
                .HasForeignKey(d => d.CompanyId)
        ...
        modelBuilder.Entity<PrincipalAuth>(entity =>
        {
            ...
            entity.HasOne(d => d.Agency).WithMany(p => p.PrincipalAuth)
                .HasForeignKey(d => d.AgencyId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("FK_PrincipalAuth_Agency");

            entity.HasOne(d => d.Category).WithMany(p => p.PrincipalAuth)
                .HasForeignKey(d => d.CategoryId)
                .HasConstraintName("FK_PrincipalAuth_Category");

            entity.HasOne(d => d.Principal).WithMany(p => p.PrincipalAuth)
                .HasForeignKey(d => d.PrincipalId)
                .HasConstraintName("FK_PrincipalAuth_Principal");

            entity.HasOne(d => d.Product).WithMany(p => p.PrincipalAuth)
                .HasForeignKey(d => d.ProductId)
        ...
        modelBuilder.Entity<PrincipalFather>(entity =>
        {
            ...
            entity.HasOne(d => d.Father).WithMany(p => p.PrincipalFatherFather)
                .HasForeignKey(d => d.FatherId)
                .HasConstraintName("FK_PrincipalFather_Father");

            entity.HasOne(d => d.Principal).WithMany(p => p.PrincipalFatherPrincipal)
                .HasForeignKey(d => d.PrincipalId)
        ...
        modelBuilder.Entity<PrincipalGrouping>(entity =>
        {
            ...
            entity.HasOne(d => d.Grouping).WithMany(p => p.PrincipalGrouping)
                .HasForeignKey(d => d.GroupingId)
                .HasConstraintName("FK_PrincipalGrouping_Grouping");

            entity.HasOne(d => d.Principal).WithMany(p => p.PrincipalGrouping)
                .HasForeignKey(d => d.PrincipalId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<PrincipalRole>(entity =>
        {
            ...
            entity.HasOne(d => d.Principal).WithMany(p => p.PrincipalRole)
                .HasForeignKey(d => d.PrincipalId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasIndex(e => new { e.PrincipalId, e.TabRegionId }, "IX_Un_PrincipalRegion").IsUnique();
            ...
            entity.HasOne(d => d.Principal).WithMany(p => p.PrincipalTabRegion)
                .HasForeignKey(d => d.PrincipalId)
                .HasConstraintName("FK_PrincipalTabRegion_Principal");

            entity.HasOne(d => d.TabRegion).WithMany(p => p.PrincipalTabRegion)
                .HasForeignKey(d => d.TabRegionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Region>(entity =>
        {
            ...
            entity.HasOne(d => d.Company).WithMany(p => p.Region)
                .HasForeignKey(d => d.CompanyId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<RoleControl>(entity =>
        {
            ...
            entity.HasOne(d => d.Control).WithMany(p => p.RoleControl)
        ...
        modelBuilder.Entity<TabCity>(entity =>
        {
            ...
            entity.HasOne(d => d.TabDistrict).WithMany(p => p.TabCity)
        ...
        modelBuilder.Entity<TabDistrict>(entity =>
        {
            ...
            entity.HasOne(d => d.TabRegion).WithMany(p => p.TabDistrict)
                .HasForeignKey(d => d.TabRegionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Warehouse>(entity =>
        {
            ...
            entity.HasOne(d => d.Salesman).WithMany(p => p.Warehouse)
                .HasForeignKey(d => d.SalesmanId)
                .HasConstraintName("FK_Warehouse_Principal");

            entity.HasOne(d => d.WarehouseType).WithMany(p => p.Warehouse)
        ...
        modelBuilder.Entity<WarehouseMovement>(entity =>
        {
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.WarehouseMovement)
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_WarehouseMovement_Product");

            entity.HasOne(d => d.WarehouseIdFromNavigation).WithMany(p => p.WarehouseMovementWarehouseIdFromNavigation)
                .HasForeignKey(d => d.WarehouseIdFrom)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_WarehouseMovement_WarehouseFrom");

            entity.HasOne(d => d.WarehouseIdToNavigation).WithMany(p => p.WarehouseMovementWarehouseIdToNavigation)
