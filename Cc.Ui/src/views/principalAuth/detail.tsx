...
export default (props: any) => {
    ...
    const isBusy = useSelector((root: RootState) => root.principalAuth.isBusy);
    const [item, setItem] = useFormItem<PrincipalAuth>(props.item || useSelector((root: RootState) => root.principalAuth.currentItem));
    ...
    return (
        <DetailView 
            title={t('views:principalAuth.detail.title')}
            isBusy={isBusy}
            content={content}
            isUpdate={isUpdate}
