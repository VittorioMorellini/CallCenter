...
import { useLocalConfigurationActions, configurationReducer } from '../../core/configuration';
...
function RelatedModalView ({ idMaster, items }: Props) {
    ...
    const { actions, state } = useLocalConfigurationActions({ items });
    useEffect(() => {
    ...
    return (
        ...
        >
            ...
            <ModalView
                ...
                fields={<Fields companies={[]} languages={[]} countries={[]} />}
            />
        </Panel>
    );
}
