...
import { useLocalAppointmentRejectActions, appointmentRejectReducer } from '../../core/appointmentReject';
...
function RelatedModalView ({ idMaster, items }: Props) {
    ...
    const { actions, state } = useLocalAppointmentRejectActions({ items });
    useEffect(() => {
