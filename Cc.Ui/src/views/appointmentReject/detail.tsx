...
export default (props: any) => {
    ...
    const isBusy = useSelector((root: RootState) => root.appointmentReject.isBusy);
    const [item, setItem] = useFormItem<AppointmentReject>(props.item || useSelector((root: RootState) => root.appointmentReject.currentItem));
    ...
    return (
        <DetailView 
            title={t('views:appointmentReject.detail.title')}
            isBusy={isBusy}
            content={content}
            isUpdate={isUpdate}
