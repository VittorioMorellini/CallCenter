...
export default (props: any) => {
    ...
    const isBusy = useSelector((root: RootState) => root.commission.isBusy);
    const [item, setItem] = useFormItem<Commission>(props.item || useSelector((root: RootState) => root.commission.currentItem));
    ...
    return (
        <DetailView 
            title={t('views:commission.detail.title')}
            isBusy={isBusy}
            content={content}
            isUpdate={isUpdate}
