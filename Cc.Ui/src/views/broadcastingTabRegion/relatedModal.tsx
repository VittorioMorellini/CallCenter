...
import { useLocalBroadcastingTabRegionActions, broadcastingTabRegionReducer } from '../../core/broadcastingTabRegion';
...
function RelatedModalView ({ idMaster, items, regions }: Props) {
    ...
    const { actions, state } = useLocalBroadcastingTabRegionActions({ items });
    useEffect(() => {
