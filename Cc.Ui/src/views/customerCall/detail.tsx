...
export default (props: any) => {
    ...
    const isBusy = useSelector((root: RootState) => root.customerCall.isBusy);
    const [item, setItem] = useFormItem<CustomerCall>(props.item || useSelector((root: RootState) => root.customerCall.currentItem));
    ...
    return (
        <DetailView 
            title={t('views:customerCall.detail.title')}
            isBusy={isBusy}
            content={content}
            isUpdate={isUpdate}
