...
export default (props: any) => {
    ...
    const isBusy = useSelector((root: RootState) => root.orderTable.isBusy);
    const [item, setItem] = useFormItem<OrderTable>(props.item || useSelector((root: RootState) => root.orderTable.currentItem));
    ...
    return (
        <DetailView 
            title={t('views:orderTable.detail.title')}
            isBusy={isBusy}
            content={content}
            isUpdate={isUpdate}
