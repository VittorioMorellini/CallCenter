...
export default (props: any) => {
    ...
    const [item, setItem] = useFormItem<AppointmentEnding>(props.item || useSelector((root: RootState) => root.appointmentEnding.currentItem));
    ...
    return (
        <DetailView 
            title={t('views:appointmentEnding.detail.title')}
            isBusy={isBusy}
            content={content}
            isUpdate={isUpdate}
