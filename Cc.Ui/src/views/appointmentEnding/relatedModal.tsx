...
import { useLocalAppointmentEndingActions, appointmentEndingReducer } from '../../core/appointmentEnding';
...
function RelatedModalView ({ idMaster, items }: Props) {
    ...
    const { actions, state } = useLocalAppointmentEndingActions({ items });
    useEffect(() => {
