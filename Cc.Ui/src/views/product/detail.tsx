...
export default (props: any) => {
    ...
    const isBusy = useSelector((root: RootState) => root.product.isBusy);
    const [item, setItem] = useFormItem<Product>(props.item || useSelector((root: RootState) => root.product.currentItem));
    ...
    return (
        <DetailView 
            title={t('views:product.detail.title')}
            isBusy={isBusy}
            content={content}
            isUpdate={isUpdate}
