...
export default (props: any) => {
    ...
    const [item, setItem] = useFormItem<WarehouseType>(props.item || useSelector((root: RootState) => root.warehouseType.currentItem));
    ...
    return (
        <DetailView 
            title={t('views:warehouseType.detail.title')}
            isBusy={isBusy}
            content={content}
            isUpdate={isUpdate}
