...
namespace Cc.Api.Controllers
{
    ...
    {
        private IBroadcastingService service;
        public BroadcastingController(IBroadcastingService service)
        {
        ...
        [HttpPost("search")]
        //[EnhanceModelFilter]
        public IActionResult Search([FromBody] BroadcastingSearchModel model)
        {
            return ServiceResult.Execute(() => service.Search(model));
        }

        [HttpPost]
        public IActionResult Save([FromBody] Broadcasting item)
        {
