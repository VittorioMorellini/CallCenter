...
namespace Cc.Api.Controllers
{
    ...
    {
        private IVatService service;
        public VatController(IVatService service)
        {
        ...
        [HttpPost("search")]
        //[EnhanceModelFilter]
        public IActionResult Search([FromBody] VatSearchModel model)
        {
            return ServiceResult.Execute(() => service.Search(model));
        }

        [HttpPost]
        public IActionResult Save([FromBody] Vat item)
        {
