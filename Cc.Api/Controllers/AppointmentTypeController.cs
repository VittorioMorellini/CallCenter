...
namespace Cc.Api.Controllers
{
    ...
    {
        private IAppointmentTypeService service;
        ...
        [HttpPost("search")]
        //[EnhanceModelFilter]
        public IActionResult Search([FromBody] AppointmentTypeSearchModel model)
        {
            return ServiceResult.Execute(() => service.Search(model));
        }

        [HttpPost]
        public IActionResult Save([FromBody] AppointmentType item)
        {
